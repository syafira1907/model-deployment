...
Agar dapat memprediksi seledri atau jeruk nipis, data input model harus mengikuti format sebagai berikut:
...
-   seledri_jeruknipis_class_model.h5 --> Model Image Classification CNN yang sudah di-training.
